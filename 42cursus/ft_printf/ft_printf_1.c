...
/*   Updated: 2022/05/30 13:51:25 by mmariani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_choose(t_print *tab, char x, char *format, int i)
{
	...
	if (x == 'c')
		ft_print_char(va_args(args, int));
	else if (x == 's')
		ft_print_string(va_arg(args, char *));
	else if (x == 'd' || x == 'i')
		ft_print_number(va_args(args, int));
	else if (x == 'u')
		ft_print_number(va_args(args, unsigned int));
	else if (x == 'p')
		ft_print_hex(va_arg(args, unsigned long));
	else if (x == 'x')
		// • %x Prints a number in hexadecimal (base 16) lowercase format.
	else if (x == 'X')
		// • %X Prints a number in hexadecimal (base 16) uppercase format.	
